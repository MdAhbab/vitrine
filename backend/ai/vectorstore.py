...
class PgVector:
    async def upsert(self, *a, **k):  # TODO Phase 2
        raise NotImplementedError("PgVector.upsert — TODO Phase 2")

    async def search(self, *a, **k):  # TODO Phase 2
        raise NotImplementedError("PgVector.search — TODO Phase 2")
